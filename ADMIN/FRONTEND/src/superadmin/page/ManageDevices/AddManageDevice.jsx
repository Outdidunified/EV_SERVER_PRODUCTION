...
const AddManageDevice = ({ userInfo, handleLogout }) => {
    ...
    const addManageDevice = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`${process.env.REACT_APP_SERVER_URL}/superadmin/CreateCharger`, {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
                body: JSON.stringify({ charger_id, charger_model, charger_type: selectChargerType, connectors, vendor, max_current, max_power, bluetooth_module, wifi_module, created_by: userInfo.data.email_id }),
            });
