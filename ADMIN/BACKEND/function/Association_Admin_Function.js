...
async function UpdateDevice(req, res, next) {
    try {
        ...
        const apiKey = process.env.GOOGLE_API_KEY; // Make sure to set this in your environment variables
        const geocodeUrl = `https://maps.googleapis.com/maps/api/geocode/json?latlng=${lat},${long}&key=${apiKey}`;

        let address = "Unknown Location"; // Default address if geocoding fails
        ...
        try {
            ...
            // You can choose to log or handle this error as needed
        }
        ...
        const updateFields = {
            ...
            modified_by: modified_by,
            modified_date: new Date(),
            address: address // Include the fetched address
        };
